...
#define DEFAULT_GGAIN           GGAIN_1X // was: GGAIN_4X but since standing in front use GGAIN_1X
#define DEFAULT_GLDRIVE         LED_DRIVE_25MA // was: LED_DRIVE_100MA  but since standing in front use LED_DRIVE_25MA
